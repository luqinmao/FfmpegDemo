...
import com.lansoeditor.demo.VideoRecordActivity;
...
public class VideoProgressView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
	...
	private void init(Context paramContext) {
		...
		perWidth = screenWidth / VideoRecordActivity.MAX_RECORD_TIME;
	...
	private void myDraw() {
		...
		if (timeList.isEmpty() || (!timeList.isEmpty() && timeList.getLast() <= VideoRecordActivity.MIN_RECORD_TIME)) {
			float left = perWidth * VideoRecordActivity.MIN_RECORD_TIME;
			if (canvas != null) {
