...
public class DemoFunctions {
	 ...
	 */
	public static int demoAVMerge(Context ctx, VideoEditor editor, String srcVideo,String inputAudio, String dstPath)
	{
		int ret=-1;
...
//	  		String audio= CopyDefaultVideoAsyncTask.copyFile(ctx,"aac20s.aac");
	  		ret=editor.executeVideoMergeAudio(video2,inputAudio, dstPath);
...
//	  		String audio= CopyDefaultVideoAsyncTask.copyFile(ctx,"aac20s.aac");
			...
			demoAddPicture(ctx,editor,dstPath,pic,mPathString+"outtt.mp4");
			SDKFileUtils.deleteFile(video3);
...
//    		return editor.executeVideoFrameCrop(srcVideo, width, height, 0, 0, dstVideo, info.vCodecName,dstBr2);  //测试.
	 ...
	 */	
	public static int demoAddPicture(Context ctx, VideoEditor editor, String srcVideo,String imagePath, String dstVideo)
	{
			MediaInfo info=new MediaInfo(srcVideo);
			if(info.prepare())
			{
	 ...
	 * 视频合成测试.
	 */
	public static int mixVideo(MyVideoEditor editor, String srcVideo, String dstVideo)
	{
		MediaInfo info=new MediaInfo(srcVideo);
		if(info.prepare())
		{
			...
			return editor.mixVideo(srcVideo,info.vCodecName,bitrate,dstVideo);
		}else{
			return -1;
		}
	}
	 ...
	 * 视频合成测试2.
	 */
	public static int mixVideo2(MyVideoEditor editor, String srcVideo1, String srcVideo2, String dstVideo)
	{
